// מערך המשפטים
var sentences = [{
    first: 'כוח סביר- מינמום', // החלק הראשון של המשפט
    missingWord: 'כוח דרוש', // המילה החסרה
    last: 'כדי לסכל התנגדות לפעילות חוקית.', // החלק האחרון של המילה (לא לשכוח לשים נקודה בסוף משפט)
    id: 'sen1', // לכתוב כך לפי סדר המיקומים המסודרים במערך זה. חשוב לא לטעות בסדר   
    mistake: false
},
{
    first: 'עריק- חייל אשר נפקד יותר מ-',
    missingWord: '21',
    last: 'יום רצופים.',
    id: 'sen2',
    mistake: false
...
{
    first: 'עריק סדיר גרעין קשה- עריק אשר משך עריקותו היא מעל',
    missingWord: 'שנה',
    last: '.',
    id: 'sen3',
    mistake: false
...
{
    first: "הבסיסים הקיימים בפיקוד צפון הם ג'למה ו-",
    missingWord: 'פילון',
    last: '.',
    id: 'sen4',
    mistake: false
...
{
    first: 'הקצין אשר רשאי לחתום על פקודת מעצר אדומה הוא קש"ב בדרגת',
    missingWord: 'רב סרן',
    last: '.',
    id: 'sen5',
    mistake: false
...
{
    first: 'הרמ"ח הוא בדרגת',
    missingWord: 'אלוף משנה',
    last: '.',
    id: 'sen6',
    mistake: false
},
{
    first: 'דרגתו של מפקד הימל"ת היא',
    missingWord: 'רב סרן',
    last: '.',
    id: 'sen7',
    mistake: false
...
{
    first: 'יחידת מ"צ דן אשר נמצאת בפיקוד מרכז יושבת בבסיס',
    missingWord: 'תל השומר',
    last: '.',
    id: 'sen8',
    mistake: false
}
